...
class InstructorTopNavBar extends Component {
    constructor(props){
        super(props);
        this.state={
            jsonList:[],
                ...
                <Navbar style={navbarheight}  expand="lg">
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="mr-auto">
                            <Nav.Link style={items}><Link to={{pathname:"./InstructorHome", state: {linkFullName: this.state.fullName, 
                                                                                                    linkUserId: this.state.userId, 
                                                                                                    linkPassword: this.state.password}}} style={{color:"black"}}>DashBoard</Link></Nav.Link>
                            <NavDropdown style={items} title="Classes" id="basic-nav-dropdown">
                                {this.state.jsonList.map((i) => (
                                    <NavDropdown.Item ><Link to={{pathname:"./InstructorClassPage", state: {linkClassCode: i.Code, 
                                ...
                                <NavDropdown.Divider />
                            <NavDropdown.Item ><Link to={{pathname: "./InstructorClassesInstructingPage", state:{linkFullName: this.state.fullName, 
                                                                                                                linkUserId: this.state.userId, 
                                                                                                                linkPassword: this.state.password}}} style={{color:"black"}}>All Classes</Link></NavDropdown.Item>
                            </NavDropdown>
                        </Nav>
